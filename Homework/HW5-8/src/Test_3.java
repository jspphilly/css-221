 ...
 * Tests for Change Scenario 2: [] -> addToRear(A) -> [A]
 * 
 * @author Matt T
 */
public class Test_3
{
	...
	//****** Constants used in tests *****************
			...
			private static final Integer LAST = TestCase.A;	
...
//******************* Tests ***************************
	...
	/**
	 * Test: remove(A) - remove elements X from list 
	 * Expected Result: Reference to elements A 
	 */
